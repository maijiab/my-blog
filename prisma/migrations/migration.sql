...
CREATE TABLE `BlogToTag` (
    ...
    UNIQUE INDEX `BlogToTag_AB_unique`(`blogId`, `tagId`),
    INDEX `BlogToTag_B_index`(`tagId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `SnippetToTag` (
    `id` VARCHAR(191) NOT NULL,
    `A` VARCHAR(191) NULL,
    `B` VARCHAR(191) NULL,
    ...
    UNIQUE INDEX `SnippetToTag_AB_unique`(`snippetId`, `tagId`),
    INDEX `SnippetToTag_B_index`(`tagId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `NoteToTag` (
    `id` VARCHAR(191) NOT NULL,
    `A` VARCHAR(191) NULL,
    `B` VARCHAR(191) NULL,
    ...
    UNIQUE INDEX `NoteToTag_AB_unique`(`noteId`, `tagId`),
    INDEX `NoteToTag_B_index`(`tagId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
